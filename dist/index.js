...
const byte_size_1 = require("./byte_size");
...
function getCalculator(seen) {
    return function calculator(object) {
        ...
        switch (objectType) {
            case 'string':
                return object.length * byte_size_1.ECMA_SIZES.STRING;
            case 'boolean':
                return byte_size_1.ECMA_SIZES.BOOLEAN;
            case 'number':
                return byte_size_1.ECMA_SIZES.NUMBER;
            case 'symbol':
                const isGlobalSymbol = Symbol.keyFor && Symbol.keyFor(object);
                return Symbol.keyFor && Symbol.keyFor(object)
                    ? Symbol.keyFor(object).length * byte_size_1.ECMA_SIZES.STRING
                    : (object.toString().length - 8) * byte_size_1.ECMA_SIZES.STRING;
            case 'object':
